<?php
require_once '../model/emotionModel.php';

class emotionController {
    public function getAllItems() {
        $mapModel = new emotionModel();
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($postData) {
                ...
                if (isset($postData['posX'])) {
                    ...
                    $success = $emotionModel->insertemotion($dataToInsert);
    ...
    public function updateAllItems() {
        if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
            ...
            if ($putData && isset($putData['emotion_id'])) {
                $emotionModel = new emotionModel();
                $success = $emotionModel->updateemotion($putData);
