<?php
require_once '../model/userActionModel.php';

class userActionController {
    public function getAllItems() {
        $mapModel = new userActionModel();
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($postData) {
                ...
                if (isset($postData['posX'])) {
                    ...
                    $success = $userActionModel->insertuserAction($dataToInsert);
    ...
    public function updateAllItems() {
        if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
            ...
            if ($putData && isset($putData['userAction_id'])) {
                $userActionModel = new userActionModel();
                $success = $userActionModel->updateuserAction($putData);
