<?php
require_once '../model/journeyPhaseModel.php';

class journeyPhaseController {
    public function getAllItems() {
        $mapModel = new journeyPhaseModel();
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($postData) {
                ...
                if (isset($postData['posX'])) {
                    ...
                    $journeyPhaseModel = new journeyPhaseModel();
                    ...
                    $success = $journeyPhaseModel->insertjourneyPhase($dataToInsert);
    ...
    public function updateAllItems() {
        if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
            ...
            if ($putData && isset($putData['journeyPhase_id'])) {
                $journeyPhaseModel = new journeyPhaseModel();
                $success = $journeyPhaseModel->updateJourneyPhase($putData);
