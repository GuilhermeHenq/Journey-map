<?php
require_once '../model/contactPointModel.php';

class contactPointController {
    public function getAllItems() {
        $mapModel = new contactPointModel();
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($postData) {
                ...
                if (isset($postData['posX'])) {
                    ...
                    $contactPointModel = new contactPointModel();
                    ...
                    $success = $contactPointModel->insertContactPoint($dataToInsert);
    ...
    public function updateAllItems() {
        if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
            ...
            if ($putData && isset($putData['contactPoint_id'])) {
                $contactPointModel = new contactPointModel();
                $success = $contactPointModel->updatecontactPoint($putData);
